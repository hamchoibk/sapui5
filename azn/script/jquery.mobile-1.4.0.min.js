	...
	_create: function() {
		var self = this,
			...
			_getWrapper = function() {
				...
				if ( $wrapper.length === 0 ) {
					$wrapper = self._page.children( ".ui-content:not(.ui-popup), .ui-footer:not(:jqmData(position='fixed'))" ).wrapAll( '<div class="' + self.options.classes.contentWrap + ' ' + _getPageTheme() + '" />' ).parent();
			...
			_getFixedToolbar = function() {
				...
				if ( $fixedToolbar.length === 0 ) {
					$fixedToolbar = self._page.find( ".ui-footer:jqmData(position='fixed')" ).addClass( self.options.classes.contentFixedToolbar );
					if ( $.support.cssTransform3d && !!self.options.animate ) {
